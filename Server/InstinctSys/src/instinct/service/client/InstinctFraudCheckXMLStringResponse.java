...
@XmlType(name = "", propOrder = { "instinctFraudCheckXMLStringResult" })
...
public class InstinctFraudCheckXMLStringResponse 
{
	...
	/**
	 * Gets the value of the instinctFraudCheckXMLStringResult property.
	 * 
	...
	/**
	 * Sets the value of the instinctFraudCheckXMLStringResult property.
	 * 
	 * @param value
