...
public class AppPhotoEvidenceCollectCheckActivityDescriptor extends ActivityDescriptor{

private String collectScenario;
    
    public AppPhotoEvidenceCollectCheckActivityDescriptor(String collectScenario) {
