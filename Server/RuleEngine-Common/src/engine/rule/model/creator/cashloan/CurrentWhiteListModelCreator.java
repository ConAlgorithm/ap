...
public class CurrentWhiteListModelCreator extends AbstractApplicationModelCreator{

    public CurrentWhiteListModelCreator(String appId) {
        super(appId);
    }

    @Override
    public Map<String, Object> createModelForm() {
        form = new ModelBuilder<CurrentWhiteListInForm>(new CurrentWhiteListInForm())
                .buidDerivativeVariables(appId).getForm();
        return CollectionUtils.mapOf("in_Whitelist", (Object) form);
    }
