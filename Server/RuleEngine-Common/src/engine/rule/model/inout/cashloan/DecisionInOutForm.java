package engine.rule.model.inout.cashloan;
...
public class DecisionInOutForm extends BaseForm {
	...
	@ModelField(name = "是否增信")
	private boolean needCreditCheck = false;

	@ModelField(name = "增信百分比")
	private Double creditCheckPercent = 0.0;
	...
	public boolean containsRecommendRole(int role) {
		Set<Integer> roleSet = CommonUtil
				.decomposeBinarySum(this.affiliateRecommendRole);
	...
	@ModelMethod(name = "让(this)的申请人重新上传(#1,<文件类型>)", paramDomains = "engine.rule.domain.UploadFileStatus")
