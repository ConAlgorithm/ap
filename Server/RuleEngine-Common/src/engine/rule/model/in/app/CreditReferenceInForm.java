...
public class CreditReferenceInForm extends BaseForm {
    ...
    /************** 前海征信 **********************/
    @DBField(fieldName = DerivativeVariableApi.StringValue, variableType = AppDerivativeVariableNames.QHZX_DATA_LATEST_BUILDTIME)
    @ModelField(name = "前海征信中最近的黑名单创建时间")
    private String latestDataBuildTime = "";
  ...
  @ModelField(name = "前海征信中风险得分")
  private int riskScore = -99;
  ...
  @ModelField(name = "前海征信中手机号是否存在欺诈风险")
  ...
  @ModelField(name = "前海征信中卡号是否存在欺诈风险")
  ...
  @ModelField(name = "前海征信中身份证号是否存在欺诈风险")
  ...
  @ModelField(name = "前海征信中IP是否存在欺诈风险")
  ...
  private String dataStatus = "";
    ...
    public String getLatestDataBuildTime() {
        return latestDataBuildTime;
    }

    public void setLatestDataBuildTime(String latestDataBuildTime) {
