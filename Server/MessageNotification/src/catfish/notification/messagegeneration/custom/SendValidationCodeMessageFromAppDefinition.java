...
public class SendValidationCodeMessageFromAppDefinition implements
    MessageDefinition {

  @Override
  public List<Message> apply(Map<String, ?> receivedMessage) {
    List<String> queryResult = MessageDatabaseApi
        .getMobileAndValidationCodeByMobile((String) receivedMessage.get("ExtraInfo"));
    ...
    String content = String.format(ResourceConfig.getResourceByName(this
        .getClass().getSimpleName(), Receiver.CUSTOMER, Channel.SHORTMESSAGE),
        queryResult.get(1));    
