...
public class PDLLoanSuccessMessageDefinition implements MessageDefinition {
  ...
  public List<Message> apply(Map<String, ?> receivedMessage) {
    ...
    return Arrays.<Message>asList(
      ...
      MessagesFactory.createMessage(receivedMessage, Channel.WECHAT, Receiver.D1, merchantContent),
      MessagesFactory.createMessage(receivedMessage, Channel.SHORTMESSAGE, Receiver.CUSTOMER, customerSMContent),
      MessagesFactory.createMessage(receivedMessage, Channel.SHORTMESSAGE, Receiver.D1, merchantContent));
  }
