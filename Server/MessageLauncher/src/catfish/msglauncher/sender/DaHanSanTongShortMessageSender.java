...
public class DaHanSanTongShortMessageSender implements MessageSender {
	...
	public void send(Message baseMessage) {
		...
		requestContent.put("account", Configuration.getDaHanSanTongShortMessageAccount());
		requestContent.put("password", Configuration.getDaHanSanTongShortMessagePassword());
		requestContent.put("phones", message.getMobile());
		requestContent.put("content", message.getContent());
		requestContent.put("sign", message.getSign() == null ? Configuration.getDaHanSanTongShortMessageSign() : message.getSign());
