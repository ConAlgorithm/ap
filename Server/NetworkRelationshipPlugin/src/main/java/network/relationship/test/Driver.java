...
//    }
    ...
    private static void validateApps(){
    	...
    	for(String appId :  reader.getAllAppIDs()){
    		int totalCount = AppDerivativeVariableManager.getAsInt(appId, AppDerivativeVariableConsts.GroupInfoUserTotalCount, 0);
    		int approveCount = AppDerivativeVariableManager.getAsInt(appId, AppDerivativeVariableConsts.GroupInfoUserApprovedCount, 0);
    		int rejectCount = AppDerivativeVariableManager.getAsInt(appId, AppDerivativeVariableConsts.GroupInfoUserRejectedCount, 1);
