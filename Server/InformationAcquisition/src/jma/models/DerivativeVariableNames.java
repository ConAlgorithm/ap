...
public class DerivativeVariableNames {
    ...
    /** 同盾V3-12个月内申请人在多个平台申请借款-个数*/
    public static final String APPLYLOANONPLATS3MONTH = "X_TDV3_ApplyLoanOnPlats3Month";
    ...
    /**第一联系人是否存在于用户通讯录*/
    public static final String ISCONTACT1_INLIST = "X_IsContact1Inlist";
    /**第二联系人是否存在于用户通讯录*/
    public static final String ISCONTACT2_INLIST = "X_IsContact2Inlist";
    /**第一联系人手机号码在用户通讯录中的称呼，不存在的话为-1*/
    public static final String CONTACT1NAME_INLIST = "X_Contact1nameInList";
    /**第二联系人手机号码在用户通讯录中的称呼，不存在的话为-1*/
    public static final String CONTACT2NAME_INLIST = "X_Contact2nameInList";
    /**第1联系人在通讯录里的称呼中是否包含姓名中的某一个字---模糊匹配*/
    public static final String ISCONTACT1TRUE = "X_IsContact1True";
    /**第2联系人在通讯录里的称呼中是否包含姓名中的某一个字---模糊匹配*/
    public static final String ISCONTACT2TRUE = "X_IsContact2True";
    /**通讯录中的所有称呼里面包含敏感词库中的敏感词的个数*/
    public static final String CONTACTNUMBEROFBLACK = "X_ContactNumberOfBlack";
    /**通讯录厚度----计算通讯录电话非重复个数，包括固话和短号*/
    public static final String CONTACTNUMBEROFMOBILE = "X_ContactNumberOfMobile";
    /**通讯录中的所有称呼里面包含“买单侠”的称呼的个数*/
    public static final String CONTACTNUMBEROFMDX = "X_ContactNumberOfMDX";
    
    /** 公司名称是否命中移动黑名单**/
    public static final String IS_BLACK_COMPANY_NAME = "X_IsMobileBlackCompanyName";
	...
	public static final String ZMXY_SCORE= "X_ZMXY_SCORE";
	 ...
	 /** 算话征信-业务流水**/
    public static final String SUANHUA_APPNUM="X_SuanHua_AppNum";
    /** 算话征信-业务类型**/
    public static final String SUANHUA_FRDCHECKTYPE="X_SuanHua_FrdCheckType";
    /** 算话征信-申请日期**/
    public static final String SUANHUA_APPDATE="X_SuanHua_AppDate";
    /** 算话征信-算话流水**/
    public static final String SUANHUA_APPNO="X_SuanHua_AppNo";
    /** 算话征信-申请数据校验结果**/
    public static final String SUANHUA_APPVALID="X_SuanHua_AppValid";
    /** 算话征信-格式检验报警**/
    public static final String SUANHUA_APPWARN="X_SuanHua_AppWarn";
    /** 算话征信-欺诈得分**/
    public static final String SUANHUA_APPRST="X_SuanHua_AppRst";
    /** 算话征信-欺诈情况说明**/
    public static final String SUANHUA_APPRSTREMARK="X_SuanHua_AppRstRemark";
    /** 算话征信-人脸识别结果**/
    public static final String SUANHUA_APPFACERST="X_SuanHua_AppFaceRst";
    /** 算话征信-涉诉黑名单**/
    public static final String SUANHUA_APPBLACKRST="X_SuanHua_AppBlackRst";
    
    //富数 start
    /** 富数返回码**/
    public static final String FUSHU_RETURN_CODE="X_FUSHU_RETURN_CODE";
    /** 富数msg**/
    public static final String FUSHU_MSG="X_FUSHU_MSG";
    /** 富数黑名单命中条件**/
    ...
    //考拉黑名单start
    /** 考拉结果**/
    public static final String KAOLA_RESULT="X_KAOLA_RESULT";
    /** 考拉描述**/
    public static final String KAOLA_MSG="X_KAOLA_MSG";
    /** 考拉借款日期**/
    ...
    //考拉个人身份回查
    /** 考拉个人身份回查结果**/
    public static final String KAOLA_IDENTIRY_RESULT="X_KAOLA_IDENTIRY_RESULT";
    /** 考拉个人身份回查描述**/
    public static final String KAOLA_IDENTIRY_MSG="X_KAOLA_IDENTIRY_MSG";
    /** 考拉个人身份回查身份证姓名**/
    ...
    //设备信息
    /** 设备信息id**/
    public static final String DEVICEINFO_ID="X_DEVICEINFO_ID";
    
    /** 设备信息name**/
    public static final String DEVICEINFO_NAME="X_DEVICEINFO_NAME";
    
    /** 设备信息纬度**/
    public static final String DEVICEINFO_LATITUDE="X_DEVICEINFO_LATITUDE";
    
    /** 设备信息经度**/
    public static final String DEVICEINFO_LOGITUDE="X_DEVICEINFO_LOGITUDE";
    ...
    /************************商汤*************************************/
    /** 人证是否一致 **/
    public static final String ST_IS_ID_NAME_MATCH = "X_ST_is_id_name_match";
    /** 身份证照与公安部照是否一致 **/
    public static final String ST_ID_POLICE_PHOTO_SIMILARITY = "X_ST_id_police_photo_similarity";
    /** 身份证照与头像照是否一致 **/
    public static final String ST_ID_HEAD_PHOTO_SIMILARITY = "X_ST_id_head_photo_similarity";
    /** 头像照与公安部照是否一致 **/
    public static final String ST_HEAD_POLICE_PHOTO_SIMILARITY = "X_ST_head_police_photo_similarity";
    /** 公安部接口失败原因 **/
    public static final String ST_POLICE_ERROR_REASON = "X_ST_police_error_reason";
    /***************************************************************/
