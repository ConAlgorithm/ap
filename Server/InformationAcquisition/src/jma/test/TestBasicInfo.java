...
import jma.handlers.CalculatePDLCurrentBasicInfoHandler;
import jma.handlers.CalculatePDLPreviousBasicInfoHandler;
...
public class TestBasicInfo {
    ...
    public static void main(String[] args) {
        ...
        CalculatePDLPreviousBasicInfoHandler handler = new CalculatePDLPreviousBasicInfoHandler();
        try {
        ...
        CalculatePDLCurrentBasicInfoHandler handler2 = new CalculatePDLCurrentBasicInfoHandler();
        try {
            handler2.execute(appId);
            //handler.execute(args[0]);
        } catch (RetryRequiredException e) {
            e.printStackTrace();
        }
